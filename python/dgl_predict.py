...
def dgl_predict(head: str, relation: str, topk: int = 10) -> list:
    # Set paths
    model_path = "model_output/rotate_wikimedia/RotatE_wikimedia_0"
    data_path = "../data/wikimedia"
    entity_dict = f"{data_path}/entities_final.dict"
    relation_dict = f"{data_path}/relations_final.dict"
...
# Example call
results = dgl_predict("neem", "MedicinalPlant_Disease", topk=10)
print("First")
